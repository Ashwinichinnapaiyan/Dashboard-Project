...
<br></br>
      <div className="extra-info">
        <div className="box">
          ...
          <p>Need help? Visit our <a href="/admin/contact">Help Center</a>.</p>
        </div>
        <div className="box">
          <h4><FontAwesomeIcon icon={faChalkboardTeacher} /> Become an Instructor</h4>
          <p>Join our platform. <a href="/student/dashboard">Apply Here</a>.</p>
        </div>
        <div className="box">
          <h4><FontAwesomeIcon icon={faHandshake} /> Partnerships</h4>
          <p>Collaborate with us. <a href="ashwini09012003@gmail.com">Contact Us</a>.</p>
        </div>
      </div>
